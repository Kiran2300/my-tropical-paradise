...
function connectFactory(BaseComponent, createElement, RendererContext, ThemeContext) {
  return function connect(rules) {
    ...
    return function (component) {
      var EnhancedComponent = /*#__PURE__*/function (_BaseComponent) {
        ...
        _createClass(EnhancedComponent, [{
          ...
          value: function render() {
            ...
            var combinedRules = _felaTools.combineMultiRules.apply(void 0, allRules);
            ...
            return createElement(RendererContext.Consumer, undefined, function (renderer) {
              return createElement(ThemeContext.Consumer, undefined, function (theme) {
                ...
                if (process.env.NODE_ENV !== 'production' && renderer.prettySelectors) {
                  ...
                  (0, _fastLoops.objectEach)(preparedRules, function (rule, name) {
                ...
                var styles = (0, _fastLoops.objectReduce)(preparedRules, function (styleMap, rule, name) {
                  styleMap[name] = renderer.renderRule(rule, _objectSpread(_objectSpread({}, otherProps), {}, {
                    theme: theme
                  }));
                  return styleMap;
                }, {});
                var boundRules = (0, _fastLoops.objectReduce)(preparedRules, function (ruleMap, rule, name) {
      ...
      _defineProperty(EnhancedComponent, "displayName", (0, _generateDisplayName["default"])(component));
